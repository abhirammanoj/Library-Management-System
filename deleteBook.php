<?php
// This module helps the admin to delete unwanted books from the library.
include("setting.php");
session_start();
...
<tr><td colspan="2" align="center"><input type="submit" value="DELETE BOOK" class="fields" /></td></tr>
</table>
</form>
<br />
<br />
