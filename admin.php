<?php
// This module represents admin login page.
include("setting.php");
session_start();
...
<tr><td class="labels">Admin ID : </td><td><input type="text" name="aid" class="fields" size="25" placeholder="Enter Admin ID" autocomplete='OFF' required="required" /></td></tr>
...
<br />
<br />
<a href="userType.php" class="link">Home Page</a>
<br />
<br />
