<?php
//admin can update details of the book .
include("setting.php");
session_start();
...
if($bn!=NULL && $au!=NULL)
{
	$sql=mysqli_query($set,"UPDATE books SET publisher='$pu' WHERE name='$bn' AND author='$au'");
	if($sql)
	{
...
<span class="SubHead">Update Books in Library</span>
<br />
<br />
...
<tr><td class="labels">New Publisher : </td><td><input type="text" name="pub" placeholder="Enter Publisher Name" size="25" class="fields" required="required"  /></td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="UPDATE BOOK" class="fields" /></td></tr>
</table>
</form>
<br />
<br />
