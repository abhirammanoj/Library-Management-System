<?php
// This module helps the admin to add books in to the library.
include("setting.php");
session_start();
...
if($bn!=NULL && $au!=NULL)
{
	$sql=mysqli_query($set,"INSERT INTO books(name,author,publisher) VALUES('$bn','$au','$pu')");
	if($sql)
	{
...
<tr><td class="labels">Publisher : </td><td><input type="text" name="pub" placeholder="Enter Publisher Name" size="25" class="fields" required="required"  /></td></tr>
